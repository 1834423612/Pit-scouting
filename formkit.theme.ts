...
/**
  ...
  *
  * @checksum - 8c1d418febcfe75db1fa58d9bd8ee9ffab62e4b287debff26b894f09c8b18356
  * @variables - radius=rounded-xl,accentColor=blue,colorTemperature=slate,spacing=2,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-none,tagRadius=rounded-full,swatchRadius=rounded
  * @theme - regenesis
  **/
