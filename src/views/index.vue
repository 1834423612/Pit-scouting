<template>
  <el-form ref="form" label-width="120px" label-position="top">
    ...
    <el-form-item v-for="x of form" :key="x.question" :label="x.question">
      ...
      <el-upload v-else-if="x.type === 'file'" v-model="x.value" class="upload-demo" drag action="x.action"
        :on-success="handleSuccess" :on-remove="handleRemove" :file-list="fileList.fullRobot" required>
